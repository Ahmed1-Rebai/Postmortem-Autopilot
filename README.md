...
The full 10-incident golden corpus is Phase 3; its numbers below are the latest
run from `evals/results/history.jsonl` (regenerated by `python -m
evals.update_readme`, never hand-edited):
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `2026-08-01 13:30 UTC` | mock | `678b6b2` | 10 | 1.00 | 1.00 | 1.000 | 0.000 | 1.00 | 1.00 | n/a | n/a |
